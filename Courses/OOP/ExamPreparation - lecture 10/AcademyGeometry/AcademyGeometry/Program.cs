...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        {
            return this.GetBaseArea() * this.GetHieght();
        }
    ...
    public class AdvanceFigureController : FigureController
    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                case "area":
                    {
                        ...
                        if (currentAsIAreaMeasurable != null)
                        {
                            ...
                            currentAsIAreaMeasurable.GetArea());
                        }
                        else
                        {
                ...
                case "volume":
                    {
                        ...
                        {
                            Console.WriteLine("{0:0.00}",
                            currentAsVolumeMeasurable.GetVolume());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
                ...
                case "normal":
                    {
                        var currentAsFlatMeasurable = this.currentFigure as IFlat;
                        if (currentAsFlatMeasurable != null)
                        {
                            Console.WriteLine(currentAsFlatMeasurable.GetNormal().ToString());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
...
namespace AcademyGeometry
{
    class Program
    {
        ...
        {
            return new AdvanceFigureController();
        }
