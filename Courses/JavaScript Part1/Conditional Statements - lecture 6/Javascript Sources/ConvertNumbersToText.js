...
(function() {
    ...
    var upToThousand,
        ...
        upToTen;
    var pronunciation = [];
    var testedNumber = parseInt(prompt("Please enter a number between 0 and 999"));

    if (!isNaN(testedNumber)) {
        if (testedNumber >= 0 && testedNumber <= 999)
        {
            if (testedNumber / 100 > 0)
            {
                upToThousand = Math.floor(testedNumber / 100);
                ...
                {
                    upToHundred = Math.floor((testedNumber % 100) / 10);
            ...
            else if (testedNumber / 10 > 0)
            {
                ...
                {
                    upToHundred = Math.floor(testedNumber / 10);
                    upToTen = ((testedNumber % 100) % 10);
                }
            }
            ...
            {
                console.log("The number is " + pronunciation.join(" and "));
            }
        ...
        {
            console.log("The number is not in the range 0 - 999.");
        }
    }
    else
    {
